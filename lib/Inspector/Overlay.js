...
class Overlay {
    ...
    inspect(nodes, name, info) {
        ...
        elements.forEach((element, index) => {
            const box = overlay_1.getNestedBoundingClientRect(element, this.window);
            const dims = overlay_1.getElementDimensions(element);
        ...
        const tipBounds = overlay_1.getNestedBoundingClientRect(this.tipBoundsWindow.document.documentElement, this.window);
